...
import { NextCloudSessionStore } from "../nextcloud-auth/NextCloudSessionStore";
...
export const OwnerAliasRoute = observer(
  ({ owner, workspace, document, sessionStore }: Props) => {
    if (!(sessionStore instanceof NextCloudSessionStore)) {
    ...
    useEffect(() => {
      ...
      (async () => {
        ...
        // const nanoId = "test_workspace.md";
        const nanoId = "workspace_nano_id";
        // const id = new TypeCellIdentifier(
        //   uri.URI.from({
        //     scheme: "typecell", // TODO
        //     authority: window.location.hostname, // TODO
        //     path: "/" + nanoId,
        //   }),
        // );
        const id = new HttpsIdentifier(
          uri.URI.parse(
